...
Botones.prototype.display = function(x,y,mx,my) {
  ...
  this.velocidadPuntos = map(this.distancia,10,100,0.1,0.3);
  if (this.distancia < 10) {
    ...
    this.angle1 = this.angle1 + this.velocidadPuntos;
    this.angle2 = this.angle2 + this.velocidadPuntos;
    this.colorBotones = color(222,222,222);
    this.colorPuntos = color(222,222,222,100);
  }
...
noFill();
stroke(250,100,100,this.ondaOpacidad);
ellipse(this.x, this.y, this.ondaRadio2, this.ondaRadio2);

  noFill();
  stroke(255,100,100,this.ondaOpacidad);
